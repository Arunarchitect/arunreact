        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} sm={6} md={6} lg={6}>
            <Card sx={{ width: '100%', height: { xs: 300, sm: 615, md: 615, lg: 615 } }} className='gradient3'>
              <CardContent>
                <h2>Budget Split</h2>
                <GanttChart title={displayedValue} budget={budget} unit={selectedUnit} onEntryValueChange={handleEntryValueChange} /> {/* Pass displayedValue and selectedUnit as props */}
              </CardContent>
            </Card>
          </Grid>
        </Grid>
